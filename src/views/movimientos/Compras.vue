    ...
    <div class="container mt-5">
            <div class="card">
                <div class="card-header bg-primary-subtle">
                    <h5 class="card-title">Compras registrados</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr v-for="(item, indice) in datos" :key="item.id">
                                            ...
                                            <td><span class="badge" :class="item.estado ? 'bg-success':'bg-danger'">{{ item.estado?'Activo':'Inactivo'}}</span></td>
                                            <td>
                                                <div class="btn-group">
                                                    <button class="btn btn-secondary btn-sm" @click="verDetalle(item.id)">❕</button>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-primary-subtle">
                        <h1 class="modal-title fs-5" id="exampleModalLabel"><i class="fas fa-edit me-2"></i>Detalle de compras</h1>
                            ...
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover" id="tabla5">
                                        ...
                                        <tbody>
                                          <tr v-for="(item, indice) in dato.detalle_compra" :key="indice">
                                              ...
                                              <td>{{item.total}}</td>
                                              <td>
                                                  <button type="button" class="btn btn-danger btn-sm" @click="removeCarrito(indice)">🗑</button>
                                              </td>
                                            <!-- <td>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><i class="fas fa-close me-2"></i>Cerrar</button>
...
import { mostrar, datosDetalle, estado } from '../services/comprasService';
